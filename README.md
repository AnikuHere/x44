...
> **Status Notice:** This project was temporarily shelved but is actively being revived and refactored. Welcome back to the architecture.
...
Execute the script natively via your terminal
```x44runTERMINAL
x44 hello.x44
```
